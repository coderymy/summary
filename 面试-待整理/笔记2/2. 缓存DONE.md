...
key-value的模式，value就是string模式

适用场景：

1、缓存数据，适用set、mset（批量缓存）

> SET  User1:name tom
>
> MSET User1:name tom User1:age 12

2、分布式锁

> setnx，不存在这个key，返回1表示成功。存在这个key返回0表示失败
...
> hset key filed1 value2 filed2 value2 ...
>
> hset user1 name "xiaoming" age 10

适合经常对对象的某个字段进行修改

![](C:\Users\coderymy\AppData\Roaming\Typora\typora-user-images\image-20221227095115499.png)



# List

![image-20221227124724880](C:\Users\coderymy\AppData\Roaming\Typora\typora-user-images\image-20221227124724880.png)

## Set

![image-20221227125257652](C:\Users\coderymy\AppData\Roaming\Typora\typora-user-images\image-20221227125257652.png)

SRANDMEMBER 可以随机获取多少个元素

## Zset

有序集合，集合的元素有一个权重（分值）的概念
